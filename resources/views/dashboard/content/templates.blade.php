    ...
    <div class="space-y-5">
        <div class="ui-page-head">
            <div>
                ...
                <h1 class="ui-page-title">Content Templates</h1>
                <p class="ui-page-sub">Reusable HTML templates with <code class="font-mono text-zinc-400">&#123;&#123;placeholder&#125;&#125;</code> variables.</p>
            </div>
        </div>
