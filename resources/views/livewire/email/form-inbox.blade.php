                ...
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <span class="badge-purple !text-[10px]">{{ $submission->form_name }}</span>
                    ...
                    <div class="flex items-center gap-1 flex-shrink-0">
                        @if (!$submission->is_read)
                            <button wire:click="markRead('{{ $submission->id }}')" class="btn-ghost text-[10px] !px-2 !py-1" title="Mark read">
                        ...
                        @endif
                        <button wire:click="markSpam('{{ $submission->id }}')" class="btn-ghost text-[10px] !px-2 !py-1 text-zinc-600 hover:text-amber-400" title="Mark spam">
                        ...
                        <button wire:click="delete('{{ $submission->id }}')" wire:confirm="Delete this submission?" class="btn-ghost text-[10px] !px-2 !py-1 text-zinc-600 hover:text-red-400" title="Delete">
