...
export default function BlogEdit({ site, post }: { site: Site; post: Post }) {
    ...
    return (
        <AppLayout title="Edit post">
            ...
            <form onSubmit={(e) => { e.preventDefault(); put(`/dashboard/sites/${site.id}/blog/${post.id}`); }}>
                <div className="space-y-6">
                    <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold text-zinc-100">Edit post</h1>
                    ...
                    <Card className="border-zinc-800 bg-[#1e1e1e]">
                        <CardContent className="pt-5 space-y-4">
                            <div className="space-y-1">
                                ...
                                <Input value={data.title} onChange={(e) => setData('title', e.target.value)} className="border-zinc-700 bg-zinc-900 text-zinc-100 text-lg" />
