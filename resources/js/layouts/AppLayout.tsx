...
function siteMenuItems(site: NavSite): SiteMenuItem[] {
    ...
    return [
        ...
        { icon: Image, label: 'Templates', href: `${baseHref}/templates` },
        { icon: Mail, label: 'Subscribers', href: `${baseHref}/subscribers` },
        { icon: Mail, label: 'Inbox', href: `${baseHref}/inbox`, badge: site.unread_inbox_count },
        { icon: ClipboardList, label: 'Reports', href: `${baseHref}/reports` },
