...
class ActivateReleaseJob implements ShouldQueue
{
    ...
    {
        $deployer->activateRelease($this->site(), $this->log(), $this->release());
    }

    public function failed(?Throwable $exception): void
    {
        app(DeployService::class)->markDeploymentFailed($this->siteId, $this->deployLogId, $this->releaseId, $exception ?: 'Release activation failed.');
    }

    public function tags(): array
    {
        return ['deploy', "site:{$this->siteId}", 'stage:activate'];
    }
