...
class EnsureSanctumApiTokenCan
{
    ...
    private function requiredAbilityForRoute(Request $request): ?string
    {
        ...
        return match ($name) {
            ...
            'api.v1.sites.git-operations' => 'platform:sites:read',
            'api.v1.sites.sync' => 'platform:sites:sync',
            'api.v1.sites.deploy' => 'platform:sites:deploy',
            'api.v1.sites.rollback' => 'platform:sites:rollback',
            'api.v1.notifications.index' => 'platform:notifications:read',
            'api.v1.notifications.read',
            'api.v1.notifications.readAll' => 'platform:notifications:write',
            default => null,
        };
    }
}
