...
Route::post('/sites', function (Request $request) {
    $validated = $request->validate([
        ...
        'project_type' => 'required|string|in:static_html,php_site,react,vue,svelte,astro,hugo,eleventy,nextjs,nuxt,custom',
        ...
        'build_command' => ['nullable', 'string', 'max:500', 'not_regex:/[;|`\$<>\r\n]/'],
        'github_token' => ['nullable', 'string', 'max:500', 'not_regex:/[\r\n]/'],
        'domain' => ['nullable', 'string', 'max:253', 'regex:/^[a-zA-Z0-9*][a-zA-Z0-9.\-*]*$/'],
        'ssl_provider' => ['nullable', 'string', 'max:100', 'not_regex:/[\r\n;{}]/'],
