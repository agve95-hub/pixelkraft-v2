...
class GitRemoteUrlRuleTest extends TestCase
{
    ...
    public function test_it_rejects_ssh_with_unknown_host(): void
    {
        $this->assertFalse($this->passes('git@attacker.com:owner/repo.git'));
    }

    public function test_it_rejects_url_without_repo_path(): void
    {
