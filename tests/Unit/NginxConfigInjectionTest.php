...
class NginxConfigInjectionTest extends TestCase
{
    ...
    public function test_domain_newline_injection_is_rejected(): void
    {
        ...
        $this->call('assertValidDomain', "example.com\n  location / { return 200 'hacked'; }");
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDomain', 'example.com; allow all');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDomain', 'example.com } location / { deny all');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDomain', 'example.com evil.com');
    }
    ...
    public function test_valid_domains_are_accepted(): void
    {
        // Should not throw
        $this->call('assertValidDomain', 'example.com');
        $this->call('assertValidDomain', 'sub.example.com');
        $this->call('assertValidDomain', '*.example.com');
        $this->call('assertValidDomain', '192.168.1.1'); // IPs allowed at this layer
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidSlug', '../evil-slug');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidSlug', 'My-Site');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidSlug', 'my_site');
    }
    ...
    {
        $this->call('assertValidSlug', 'my-site');
        $this->call('assertValidSlug', 'site123');
        $this->call('assertValidSlug', 'a');
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDeployPath', "/var/www/site\n  allow all;");
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDeployPath', '/var/www/site; deny all');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDeployPath', '/var/www/site } location / { deny all');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDeployPath', 'relative/path');
    }
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->call('assertValidDeployPath', '');
    }

    /** @test */
    public function test_valid_deploy_paths_are_accepted(): void
    {
        $this->call('assertValidDeployPath', '/var/www/html');
        $this->call('assertValidDeployPath', '/srv/sites/my-site/dist');
        $this->call('assertValidDeployPath', '/home/deploy/pixelkraft-sites/my-site');
        $this->assertTrue(true);
    }
    ...
    {
        $result = $this->call('sanitizeRedirectToPath', "/target\n; deny all { }");
    ...
    {
        $result = $this->call('sanitizeRedirectToPath', '/new/path');
